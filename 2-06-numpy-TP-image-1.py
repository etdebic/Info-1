...
# %%
#Bl=np.ones(shape=(91,91,3),dtype=np.uint8)*255
#plt.imshow(Bl)
#N=np.zeros(shape=(91,91,3),dtype=np.uint8)
#plt.imshow(N)
J=np.array([255,255,0]*((91**2)))
J.resize(91,91,3)
plt.imshow(J)
print(J[0],J[-1])
...
print(np.shape(Im))
(l,c)=(100,200)
Im1=Im[533//2-l//2:533//2+l//2,800//2-l//2:800//2+l//2]
plt.imshow(Im1)
...
Im=plt.imread("les-mines.jpg")
Im1=Im.copy()
Car=np.array([219,112,147]*(200**2))
Car.resize(200,200,3)
Im1[-200:,-200:]=Car
plt.imshow(Im1)
...
# %%
Im=plt.imread("les-mines.jpg")
E=np.empty(shape=(533,800,4),dtype=np.uint8)
Im1=Im.copy()
E[:,:,0:3]=Im1
E[::,::,-1]=120
plt.imshow(E)
...
Im1=Im.copy()
Im1=Im1*(1/255)
Im1=Im1[:,:,0]*0.299+Im1[:,:,1]*0.587+Im[:,:,2]*0.114
Im1=np.power(Im1,1/2)
plt.imshow(Im1)
...
Im1=Im.copy()
Im1=Im1*(1/255)
Im2=Im1[:,:,0]*(1/3)+Im1[:,:,1]*(1/3)+Im[:,:,2]*(1/3)
Im3=Im1[:,:,0]*0.299+Im1[:,:,1]*0.587+Im[:,:,2]*0.114
Im4=np.power(Im1,1/2)
